...
/// <summary>
/// Handles soft-deleting a banner. The record is retained in the database for audit purposes.
/// The associated S3 image is not deleted — use the image upload endpoint to replace it before deletion if needed.
/// </summary>
