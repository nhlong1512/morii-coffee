...
internal static class EmailTemplates
{
    ...
    /// <summary>Generates the welcome email HTML, substituting the user's display name and storefront URL.</summary>
    /// <param name="name">The user's display name shown in the greeting.</param>
    /// <param name="storefrontUrl">URL to the storefront homepage (CTA button link).</param>
    public static string WelcomeEmail(string name, string storefrontUrl)
    {
