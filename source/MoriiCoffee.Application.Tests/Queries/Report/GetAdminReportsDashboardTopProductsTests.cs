...
public class GetAdminReportsDashboardTopProductsTests
{
    [Fact]
    public async Task Handle_MapsTopProducts()
    {
        ...
        result.TopProducts.Items.Should().ContainSingle(x => x.ProductName == "Iced Americano" && x.GrossRevenue == 540000m);
    }
}
